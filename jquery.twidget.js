...
;( function( $, window, document, undefined ) {
    ...
    $.extend( Plugin.prototype, {
        ...
        widget_html: function() {
            ...
            '                                <input type="text" id="twidget-origin" class="departure" name="departure" placeholder="'+_this.settings.localization.avia_input_origin_label+'" required>'+
            ...
            '                                <input type="text" name="arrival" class="arrival" ' + (_this.settings.lock_destination ? 'disabled' : '') + ' id="twidget-destination" placeholder="'+_this.settings.localization.avia_input_destination_label+'" required>'+
            ...
            '                            <div class="button" type="submit">'+_this.settings.localization.avia_submit_button_text+'</div>'+
            '                        </li>'+
            '                    </ul>'+
            '                </form>'+
            ...
            '                </div>'+
            '                <form action="" method="post" autocomplete="off" ' + (_this.settings.open_in_new_tab ? 'target="_blank"' : '') + '>'+
            '                    <ul class="twidget-form-list clearfix">'+
            '                        <!-- hotel city input -->'+
